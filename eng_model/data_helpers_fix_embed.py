...
def get_datasets_mrpolarity_pandas(positive_data_file, negative_data_file):
    """ 
    ...
    df_pos_r = pd.read_csv(positive_data_file, names=['C_T'], index_col=False)
    positive_examples = list(df_pos_r['C_T'])
    positive_examples = [s.strip() for s in positive_examples]
    
    df_neg_r = pd.read_csv(negative_data_file, names=['C_T'], index_col=False)
    negative_examples = list(df_neg_r['C_T'])
